...
export const strings = {
  en: {
    ...
    signOut: "Sign out",
    loginTitle: "Sign in",
    loginSub: "Sign in with your Google account to enter the Quantum Learning Hub.",
    continueWithGoogle: "Continue with Google",
    loginNote: "Your Google account is only used to sign you in — no password to remember.",
  ...
  hi: {
    ...
    loginSub: "Quantum Learning Hub में जाने के लिए अपने Google account से साइन इन करें।",
    continueWithGoogle: "Google से जारी रखें",
    loginNote: "आपका Google account सिर्फ़ साइन इन के लिए इस्तेमाल होगा — कोई password याद रखने की ज़रूरत नहीं।",
