...
export const lessonContentHi = {
  ...
  "phil-why-philosophy": {
    ...
    `,
    deeper: raw`
      <p>चलिए “why philosophy” तर्क को सटीक बनाते हैं। Quantum mechanics के 2 हिस्से हैं, और उनकी philosophical स्थिति बहुत अलग है। पहला है <strong>unitary evolution</strong> — Schrödinger equation,</p>
  ...
  "phil-interpretations": {
    ...
    keyPoints: [
      ...
      "QBism: wavefunction agent के personal beliefs हैं, collapse belief update है, entanglement की spookiness घुल जाती है। Relational QM: facts सिर्फ़ observer के सापेक्ष मौजूद हैं। Frauchiger–Renner (2018) हर interpretation को 3 में से एक sacrifice करने पर मजबूर करता है: universality, single world, या inter-agent consistency।",
    ],
    quiz: [
      {
      ...
      {
        q: "Everett (many-worlds) interpretation के 2 मशहूर open problems क्या हैं?",
        options: [
  ...
  "phil-randomness-free-will": {
    ...
    keyPoints: [
      ...
      "सटीक फ़ैसला: local realism मर चुका है — realism, locality और statistical independence 3 एक साथ नहीं बच सकते। Live exits: nonlocality (Bohm), anti-realism (Copenhagen/QBism), superdeterminism, many-worlds।",
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "Local realism — pre-determined outcomes, locality और freely chosen settings का conjunction; 3 में से कम से कम एक को जाना होगा",
  ...
  "phil-it-from-bit": {
    simple: raw`
      ...
      <p>अब Wheeler की provocation को 2 हिस्सों में बाँटिए — एक settled, एक पूरी तरह खुला। <strong>Settled half</strong>: “information is physical।” 1961 में IBM के <strong>Rolf Landauer</strong> ने साबित किया कि information के एक bit को <em>erase</em> करने की minimum thermodynamic cost होती है — room temperature पर लगभग 3 zeptojoules — क्योंकि erasure 2 possibilities को एक में squeeze करता है, और खोई हुई entropy कहीं न कहीं heat के रूप में जानी चाहिए। 2012 में इसे experimentally verify किया गया। Information physics के ऊपर तैरता abstraction नहीं है; वह physics <em>से बनी</em> है। आपका quantum computer भी इसका पालन करता है: हर quantum gate reversible (unitary) है, इसलिए computation की energy cost सिर्फ़ वहीं आती है जहाँ irreversibility आती है — initialization और measurement।</p>
    ...
    keyPoints: [
      ...
      "Reconstruction program information principles से QM rebuild करता है: Hardy (2001) — K=N² बनाम classical K=N, continuity axiom quantum/classical dividing line के रूप में; Chiribella–D'Ariano–Perinotti (2011) — purification principle plus 5 operational axioms quantum theory को force करते हैं।",
...
"nobel-2025-clarke-devoret-martinis": {
  ...
  `,
  deeper: raw`
      <p><strong>Josephson junction</strong> 2 superconductors होते हैं, जिनके बीच एक पतली insulating barrier होती है। superconductor के अंदर electrons <strong>Cooper pairs</strong> में बंध जाते हैं, जो एक ही macroscopic quantum phase साझा करते हैं — एक wavefunction से describe किए गए अरबों pairs। pairs barrier के आर-पार tunnel कर सकते हैं, और supercurrent उसके दोनों ओर के phase difference \\(\\delta\\) पर निर्भर करता है: \\(I = I_c \\sin \\delta\\)। यही phase वह macroscopic quantum variable है, जिसे क्लार्क, डेवोरे और मार्टिनिस ने quantized किया।</p>
  ...
  `,
  keyPoints: [
    "7 October 2025 को घोषणा — 7 October 1985 के PRL paper (मार्टिनिस, डेवोरे और क्लार्क, PRL 55, 1543) के ठीक 40 साल बाद — citation के साथ \"for the discovery of macroscopic quantum mechanical tunnelling and energy quantisation in an electric circuit\"; 11M SEK 3 में बराबर बँटा; 10 December 2025 को Stockholm में प्रदान (presentation speech गोरान जोहानसन ने दी, banquet speech डेवोरे ने)।",
